...
namespace Client.Main.Configuration
{
    ...
    public class GraphicsSettings
    {
        ...
        public string ShadowQuality { get; set; } = "Off";
        public bool Grass { get; set; } = true;
        public bool DynamicLights { get; set; } = true;
        public bool WeaponTrails { get; set; } = true;
        public bool HighQualityTextures { get; set; } = true;
        public bool OptimizeForIntegratedGpu { get; set; }
    }
